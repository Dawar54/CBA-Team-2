...
import { FaShoppingCart, FaUser, FaBell, FaHeart, FaSun, FaMoon } from 'react-icons/fa';
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Nav className="ms-auto" style={{ alignItems: 'center' }}>
                            ...
                            {/* Theme Toggle */}
                            <Nav.Link onClick={toggleTheme} className="d-flex align-items-center me-2" style={{ cursor: 'pointer' }}>
                                {isDarkMode ? <FaSun className="text-warning fs-5" title="Switch to Light Mode" /> : <FaMoon className="fs-5" title="Switch to Dark Mode" />}
                            </Nav.Link>
