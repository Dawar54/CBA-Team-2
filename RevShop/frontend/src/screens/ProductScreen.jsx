                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item className="border-0 bg-transparent">
                                    <div className="d-flex align-items-center gap-2">
                                        ...
                                        <span className="text-muted">({product.numReviews} {product.numReviews === 1 ? 'review' : 'reviews'})</span>
                                    </div>
                                </ListGroup.Item>
                        ...
                        {product.reviews && product.reviews.length > 0 && (
                            <Col md={4} className="mb-4">
                                <div className="rating-summary-card">
                                    ...
                                    <div className="text-muted mt-1">{product.numReviews} {product.numReviews === 1 ? 'review' : 'reviews'}</div>
                                    <div className="mt-3">
                        ...
                        <Col md={product.reviews && product.reviews.length > 0 ? 8 : 12}>
                            ...
                            <ListGroup variant="flush" className="review-list">
                                {product.reviews && product.reviews.map((review) => {
                                    const isOwn = review.buyerId?._id === userInfo?._id || review.buyerId === userInfo?._id;
                                    return (
